 ...
 * @author Gondan
 */
public class EncargadoCEMServicio {
    
    private JdbcTemplate jt;
    
    public EncargadoCEMServicio(){
        Conectar cn = new Conectar();
        jt = new JdbcTemplate(cn.conectar());
    }
    
    /***
     * Metodo que permite ingresar un registro en tabla Usuario
     * @param _username
     * @param _pass
     * @param _nombre
     * @param _apellido
    ...
    public String agregarUsuario(String _username, String _pass, String _nombre, String _apellido,String _email){
        jt.update("INSERT INTO usuario (id_usuario, username, clave, nombre_usuario,apellido_usuario,email_usuario,fk_id_tipo)"
                + " VALUES(USUARIOSEQ.NEXTVAL,?,?,?,?,?,2)", _username, _pass, _nombre, _apellido, _email)
                ;
...
//        return jt.query("SELECT * FROM usuario WHERE fk_id_tipo=2 ", new UsuarioRowMapper());
//       
//    }
...
//        
//        return jt.query("SELECT * FROM usuario WHERE fk_id_tipo=2 AND username LIKE ?", 
